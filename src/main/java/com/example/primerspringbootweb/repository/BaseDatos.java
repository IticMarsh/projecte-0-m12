package com.example.primerspringbootweb.repository;

import java.util.ArrayList;
import java.util.Iterator;

import com.example.primerspringbootweb.bean.Libro;
...
public class BaseDatos {
	...
	public BaseDatos() {
		...
		libros.add(new Libro(9, "EL TUMULTO", "H.P LOVECRAFT", "DEBATE", "6/9/2006 0:00:00", "CIENCIA"));
		libros.add(new Libro(10, "PERSONAJES MITICOS", "RICHARD HOLLIGHAM", "DEBATE", "7/9/2006 0:00:00", "ENTRETENIMIENTO"));
		libros.add(new Libro(11, "EL TIEMPO", "J.K ROWLINS", "SALAMANDRA", "7/9/2006 0:00:00", "CIENCIA"));
		libros.add(new Libro(12, "DIETAS MEDITERRANEAS", "ARTURO PEREZ LOPEZ", "ARIEL", "16/9/2006 0:00:00", "CIENCIA"));
